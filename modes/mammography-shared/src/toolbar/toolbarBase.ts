/**
 * Shared toolbar button definitions for mammography modes
 * Contains all buttons common to both mammography and mammography-compare
 */
...
/**
 * Section buttons (common to both modes)
 */
export const sectionButtons: Button[] = [
  {
    id: 'MeasurementTools',
...
/**
 * Mammography-specific common buttons (MammoMagnify, SyncAll, Compare)
 */
export const mammoMagnifyButton: Button = {
  id: 'MammoMagnify',
  ...
  props: {
    ...
    evaluate: 'evaluate.mammography.magnify',
  },
};

export const syncAllImagesButton: Button = {
  id: 'SyncAllImages',
  uiType: 'ohif.toolButton',
  props: {
    icon: 'link',
    label: i18n.t('Buttons:Sync All'),
    tooltip: i18n.t('Buttons:Synchronize pan/zoom/contrast across all viewports'),
    commands: { commandName: 'toggleMammoSync', context: 'MAMMOGRAPHY' },
    evaluate: 'evaluate.mammography.sync',
  },
};

export const mammoCompareButton: Button = {
  id: 'MammoCompare',
  uiType: 'ohif.toolButton',
  props: {
    icon: 'tab-studies',
    label: i18n.t('Buttons:Compare'),
    tooltip: i18n.t('Buttons:Compare with prior study'),
    commands: { commandName: 'openMammoCompare', context: 'MAMMOGRAPHY' },
    evaluate: 'evaluate.mammography.compare',
  },
};

/**
 * All generic tool buttons shared between modes
 */
export const genericToolButtons: Button[] = [
  // tool defs
  {
...
/**
 * Create the base toolbar buttons array with sections + mammo buttons + generic tools.
 * Mode-specific buttons should be inserted between mammo buttons and generic tools.
 */
export function createBaseToolbarButtons(modeSpecificButtons: Button[] = []): Button[] {
  return [
    ...sectionButtons,
    mammoMagnifyButton,
    syncAllImagesButton,
